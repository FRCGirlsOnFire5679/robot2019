...
#self.__hsv_threshold_hue = [67.98560765149782, 93.99317406143345]
#self.__hsv_threshold_saturation = [83.47122105334303, 255.0]
#self.__hsv_threshold_value = [68.79496074837746, 255.0]
# define range of green of retroreflective tape in HSV
lower_green = np.array([67.98560765149782,83.47122105334303,68.79496074837746])
upper_green = np.array([93.99317406143345, 255, 255])
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if(networkTable.getBoolean("Driver", False)):
            cap.autoExpose = True
            processed = frame	
            networkTable.putBoolean("Driver Code", True)
        else:
            ...
            if(networkTable.getBoolean("Tape", False)):
                ...
                networkTable.putBoolean("Tape Code", True)
                ...
                networkTable.putBoolean("Cargo Code", True)
                cap.autoExpose = True
